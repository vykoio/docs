...
### <Pill type="POST">GET</Pill> /:id/credentials

Returns the email and password.

**Note:** Yes, the email and password will be returned in plaintext. It is encrypted in our database, however. This is not insecure because the worst anyone is able to do is just send emails into your inbox. However, you can set a custom password for your inbox and such will be encrypted and not able to be returned to your team - sharing is annoying, especially when it's being regenerated.
